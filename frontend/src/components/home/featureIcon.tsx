import { ArrowUpRightIcon, ArrowDownLeftIcon, ArrowLeftRightIcon, CircleDollarSignIcon } from "lucide-react";
...
export { ArrowUpRightIcon, ArrowDownLeftIcon, ArrowLeftRightIcon, CircleDollarSignIcon };