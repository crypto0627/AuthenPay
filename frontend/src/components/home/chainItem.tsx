        ...
        <React.Fragment>
            <div className='w-[330px] flex justify-between'>
                <div className="p-3 flex items-center justify-start text-black gap-4">
                    <div className="flex-shrink-0 gap-2 h-[20px]">
