...
export function SenderBlock({
  ...
  return (
    <div className="relative w-[330px] py-4 px-4 text-black glass my-4 rounded-[24px] text-black">
        ...
        {status > 0 &&
          (status == 1 ? (
            <div className="flex gap-2 items-center">
              <div className="text-orange-300">Processing</div>
              <div role="status">
                <svg
                  aria-hidden="true"
                  className="w-4 h-4 text-gray-200 animate-spin fill-orange-300"
                  viewBox="0 0 100 101"
                  fill="none"
